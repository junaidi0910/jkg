	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main">
								...
								<div class="row">
									<div class="col-md-12 align-self-center p-static order-2 text-center">
										<div class="overflow-hidden pb-2">
											<h1 class="text-white font-weight-bold text-9 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100">SAUBER</h2>
										</div>
									</div>
									<div class="col-md-12 align-self-center order-1">
										<ul class="breadcrumb d-block text-center appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="300">
											<li><a href="index.php">Our House</a></li>
											<li class="text-white"><a href="ourworks.php">Our Works</a></li>
											<li class="active text-white">SAUBER</li>
										</ul>
									</div>
								</div>
							</div>
				...
				<div id="revolutionSliderCarouselContainer" class="rev_slider_wrapper fullwidthbanner-container mb-4 kotak-putih" data-alias="" style="background: #303030; height: 600px;">	
					<div id="revolutionSliderCarousel" class="rev_slider fullwidthabanner kotak-putih" data-version="5.4.8">
						<ul>
							<li data-index="rs-1" data-transition="fade" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="" data-description="">
								<img src="img/portofolio/sauber/edit.jpg" alt="" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							</li>
							<li data-index="rs-2" data-transition="fade" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="" data-description="">
								<img src="img/portofolio/sauber/_DSC6711.JPG" alt="" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							</li>
							<li data-index="rs-3" data-transition="fade" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="" data-description="">
								<img src="img/portofolio/sauber/_DSC8100.JPG" alt="" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							</li>
							<li data-index="rs-4" data-transition="fade" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="" data-description="">
								<img src="img/portofolio/sauber/_DSC8106.JPG" alt="" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							</li>
							<li data-index="rs-5" data-transition="fade" data-slotamount="7" data-easein="default" data-easeout="default" data-masterspeed="300" data-rotate="0" data-saveperformance="off" data-title="" data-description="">
								<img src="img/portofolio/sauber/_DSC9013.JPG" alt="" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
							</li>
				...
				<section  class="section section-height-1 border-0 m-0"  style="background: #303030;" >
					...
					<div class="row pb-5 pt-2">
						...
						<div class="col-md-5 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="900">
							...
							<ul class="list list-icons list-primary list-borders text-2">
								...
								<li><i class="fas fa-caret-right left-10"></i> <strong class="text-color-primary">Icons IG:</strong> <a href="#" target="_blank" class="text-dark">http://www.okler.net</a></li>
							</ul>
						</div>
					</div>
				...
				<section class="section section-height-1 border-0 m-0"  style="background-image: url('img/demos/digital-agency-2/bg/bg-baru.jpg'); background-size: cover; background-position: center;">
						...
						<div class="row portfolio-list">
							...
							<div class="col-md-6 isotope-item websites">
								<div class="portfolio-item">
										...
										<span class="thumb-info thumb-info-lighten border-radius-0">
											<span class="thumb-info-wrapper border-radius-0">
												<img src="img/lazy.png" data-src="img/projects/project-masonry-29.jpg" class="lazyload img-fluid border-radius-0" alt="">
